...
A: Yes, but you'll need to set up authentication. See [Remote Access](../cli/serve.md#authentication).
...
- [**Managing Tasks with the Web UI**](web-ui-tasks.md) - Learn advanced task workflows
- [**Web UI vs CLI**](web-ui-vs-cli.md) - Understand when to use each interface
- [**Task Providers**](../providers/index.md) - Connect to GitHub, Jira, Linear, and more
- [**Configuration**](../configuration/index.md) - Customize agents, workflow, and settings
