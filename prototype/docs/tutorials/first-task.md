...
Want to refine the plan? Add a note:

```bash
mehr note "Use the chi router pattern we already have"
```
...
- [Iterative Development](tutorials/iterative-development.md) - Refine with notes
