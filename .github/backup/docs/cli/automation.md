...
> **Note: Internet-Accessible Server Required**
>
> Automation requires that the server is accessible from the internet so that GitHub/GitLab webhooks can reach it. Use a tunneling service (ngrok, cloudflared) for development or deploy to a public server or cloud instance.
