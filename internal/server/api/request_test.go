...
func TestIsHTMXRequest(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			r := &http.Request{
				Header: http.Header{"Hx-Request": []string{tt.header}},
			}
			got := IsHTMXRequest(r)
			if got != tt.want {
...
func TestHTMXTrigger(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			r := &http.Request{
				Header: http.Header{"Hx-Trigger": []string{tt.header}},
			}
			got := HTMXTrigger(r)
			if got != tt.want {
				t.Errorf("HTMXTrigger() = %q, want %q", got, tt.want)
			}
		})
	}
}
...
func TestHTMXTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			r := &http.Request{
				Header: http.Header{"Hx-Target": []string{tt.header}},
			}
			got := HTMXTarget(r)
			if got != tt.want {
				t.Errorf("HTMXTarget() = %q, want %q", got, tt.want)
			}
		})
	}
}

func TestHTMXCurrentURL(t *testing.T) {
	tests := []struct {
		name   string
		header string
		want   string
		...
		{
			name:   "current URL present",
			header: "http://example.com/page",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			r := &http.Request{
				Header: http.Header{"Hx-Current-Url": []string{tt.header}},
			}
			got := HTMXCurrentURL(r)
			if got != tt.want {
				t.Errorf("HTMXCurrentURL() = %q, want %q", got, tt.want)
			}
		})
	}
}
